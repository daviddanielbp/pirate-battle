...
| Maximum frame time | 17.8 ms |
| Average entities (ships + projectiles) | 3.5 |
| Peak entities | 10 |
...
| --- | ---: |
| 0 (menu, after the 3-minute battle) | 9.84 |
| 1 | 10.15 |
| 2 | 10.39 |
| 3 | 10.50 |
| 4 | 10.65 |
...
- The p95 of 17.6 ms sits one sample bucket above the 16.7 ms frame budget: `requestAnimationFrame` timestamps on this machine alternate between 16.6 and 17.x ms under the Playwright automation hooks, and the average stays at 60 FPS with no frame above 17.8 ms.
